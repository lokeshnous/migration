...
public interface MMJBCommonConstants {
	...
	StringBuffer employerEmailHeader = new StringBuffer(
			"<body style=\"margin:0; padding:0; background-color:#FFFFFF;\">"
					...
					+ "<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"728\" align=\"center\" style=\"border:1px solid #cccccc;\">"
					+ "<tr><td width=\"426\" align=\"center\" valign=\"middle\" style=\"padding-bottom:5px; padding-top:5px;\"><a href=\"http://health-care-jobs.advanceweb.com\" target=\"_blank\"><img src=\"http://www.advanceweb.com/web/AdvertisingPromos/2012/JobBoardTemplates/JBlogo1.jpg\" alt=\"ADVANCE Healthcare Jobs\" width=\"426\" height=\"89\" border=\"0\" /></a></td>"
	...
	StringBuffer employerChangePwdBody = new StringBuffer(
			"<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"100%\"><tr>"
					...
					+ "<br />"
					+ "<span align=\"left\"style=\"font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#FF9900;\"><strong>YOUR PASSWORD HAS BEEN SUCCESSFULLY CHANGED</strong></span><br />"
					+ "<span style=\"font-family:Arial, Helvetica, sans-serif; font-size:15px; color:#333333;\"><br />"
					+ "Your password for the following account has been successfully changed.<br/>"
					+ "<br/>"
					+ "</span>"
					...
					+ "<tr>"
					+ " <td width=\"50%\" align=\"center\" valign=\"middle\" style=\"padding-top:5px; padding-bottom:5px; border:1px solid #cccccc; background-color:#FFFFFF;\"><span style=\"font-family:Arial, Helvetica, sans-serif; font-size:14px;\"><strong>USER</strong></span></td>"
					+ " <td width=\"50%\" align=\"center\" valign=\"middle\" style=\"padding-top:5px; padding-bottom:5px; border:1px solid #CCCCCC; background-color:#FFFFFF;\"><span style=\"font-family:Arial, Helvetica, sans-serif; font-size:14px; color: #333333\"><strong>COMPANY</strong></span></td>"
					+ "</tr>"
					+ "<tr>"
					+ " <td width=\"50%\" align=\"center\" valign=\"middle\" style=\"padding-top:5px; padding-bottom:5px; border:1px solid #cccccc;\"><span style=\"font-family:Arial, Helvetica, sans-serif; font-size:14px;\">?user_name</span></td>"
					+ " <td width=\"50%\" align=\"center\" valign=\"middle\" style=\"padding-top:5px; padding-bottom:5px; border:1px solid #cccccc;\"><span style=\"font-family:Arial, Helvetica, sans-serif; font-size:14px;\">?company_name</span></td>"
					+ "</tr>"
					+ "</table>"
					+ "<span style=\"font-family:Arial, Helvetica, sans-serif; font-size:15px; color:#333333;\"><br />"
					+ "You can <a href=\"?empdashboardLink\" style=\"color:#FF9900;\"><strong>log in now</strong></a> using your new password. <br />"
					+ "<br />"
	...
	StringBuffer jobSeekerChangePwdBody = new StringBuffer(
			"<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"100%\"><tr>"
					...
					+ "<br /><span style=\"font-family:Arial, Helvetica, sans-serif; font-size:15px; color:#333333;\">"
	...
	StringBuffer jobSeekerWelcomeMailBody = new StringBuffer(
			"<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"100%\">"
					...
					+ "<br /><span style=\"font-family:Arial, Helvetica, sans-serif; font-size:15px; color:#333333;\"><br />Hello "
					+ "?jobSeekerFirstName,<br /><br />Your account is now active on the <em>ADVANCE</em> Healthcare Jobs website. "
	...
	StringBuffer employerWelcomeMailBody = new StringBuffer(
			"<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"100%\">"
					...
					+ "<strong>WELCOME TO ADVANCE HEALTHCARE JOBS</strong></span><br /><span style=\"font-family:Arial, Helvetica, sans-serif; font-size:15px; color:#333333;\">"
					+ "<br />Hello ?userName ,<br /><br />The following account is now active on the <em>ADVANCE Healthcare Jobs</em> website."
					+ "<br/><br/></span><table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" width=\"100%\" "
					+ "style=\"font-size:13px; padding-top:0px; font-family:Arial, Helvetica, sans-serif;\"><tr><td width=\"50%\" align=\"center\" valign=\"middle\" style=\"padding-top:5px; padding-bottom:5px; border:1px solid #cccccc; background-color:#FFFFFF;\"><span style=\"font-family:Arial, Helvetica, sans-serif; font-size:14px;\">"
					+ "<strong>USER</strong></span></td> <td width=\"50%\" align=\"center\" valign=\"middle\" style=\"padding-top:5px; padding-bottom:5px; border:1px solid #CCCCCC; background-color:#FFFFFF;\"><span style=\"font-family:Arial, Helvetica, sans-serif; font-size:14px; color: #333333\"><strong>COMPANY</strong></span>"
					+ "</td></tr><tr> <td width=\"50%\" align=\"center\" valign=\"middle\" style=\"padding-top:5px; padding-bottom:5px; border:1px solid #cccccc;\"><span style=\"font-family:Arial, Helvetica, sans-serif; font-size:14px;\">?user_name</span>"
					+ "</td> <td width=\"50%\" align=\"center\" valign=\"middle\" style=\"padding-top:5px; padding-bottom:5px; border:1px solid #cccccc;\"><span style=\"font-family:Arial, Helvetica, sans-serif; font-size:14px;\">?company_name</span>"
