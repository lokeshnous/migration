...
public class CustomerDetailsWSTest extends ServiceTest {
	...
	public String getCustomerDetails() {
		WebClient client = WebClient
				.create("https://rest.netsuite.com/app/site/hosting/restlet.nl?script=65&deploy=1");
		client.header(
				"Authorization",
				"NLAuth nlauth_account=TSTDRV617993, nlauth_email=dharmarajns@nous.soft.net, nlauth_signature=dharma123, nlauth_role=3");
	...
	public String authorizeUser() {
		...
		WebClient client = WebClient
				.create("https://rest.netsuite.com/app/site/hosting/restlet.nl?script=85&deploy=1");
		client.header(
				"Authorization",
				"NLAuth nlauth_account=TSTDRV617993, nlauth_email=dharmarajns@nous.soft.net, nlauth_signature=dharma123, nlauth_role=3");
		client.header("Content-Type", "application/json");
