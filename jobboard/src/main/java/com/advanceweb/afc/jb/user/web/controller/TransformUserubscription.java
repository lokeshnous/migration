...
public class TransformUserubscription {
	...
	public List<DropDownDTO> jsSubscriptionDTOToJobSeekerSubscriptions(
		...
		List<String> currEmailList = new ArrayList<String>();
				...
				for (DropDownDTO subdto : listSubscriptions) {
					if (subdto.getOptionId().equals(
						...
						if (subdto
								.getOptionId()
								.equalsIgnoreCase(
										Integer.toString(MMJBCommonConstants.EMAIL_JS_SUBSCRIPTION))) {
							currEmailList.add(Integer.toString(dto
									.getPublicationId()));
						}
					}
				}
				...
				for (DropDownDTO subdto : listSubscriptions) {
					if (subdto.getOptionId().equals(
						...
						if (subdto
								.getOptionId()
								.equalsIgnoreCase(
										Integer.toString(MMJBCommonConstants.EMAIL_SUBSCRIPTION))) {
							currEmailList.add(Integer.toString(dto
									.getPublicationId()));
						}
					}
