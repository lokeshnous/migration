...
<script type="text/javascript">
										...
										function(event) {
											...
											case "delete": {
												...
												if (r == true) {
													$
															.ajax({
																url : "${pageContext.request.contextPath}/jobSeekerCoverLetter/deleteManageExistCoverLetter.html?coverletterId="
																		+ saveSearchId,
																success : function(
																		data) {
	...
	function openwin(where) {
		window.open(where, "TempWindow",
				"width=300,height=210,resizable=yes,status=yes");
	}
	...
	function printPopup(id) {
		...
		document.location.href = ('../jobSeekerCoverLetter/jobseekerPrintCoverLetter.html?coverletterId='
				+ coverletterId + '&type=Print');
	}
</script>
		...
		<div class="popUpContainerWrapper">
			<form:form action="" method="GET" commandname="resCoverLetterForm">
				<div class="rowEvenNewSpacing marginTop0">
					<table id="tb_cover_letter" width="100%" class="grid" border="0"
