    ...
    <div class="main">
      ...
      <c:if test="${not empty errorMessage}">
        ...
        <div class="row">
 				...
 				<form:select path="jobOwner" class="jb_input3 jb_input_width3" disabled="true">
              ...
              <div class="rowEvenNewSpacing"> <span class="lableText3">Customer Number:</span>
               ...
               <div class="rowEvenNewSpacing"> <span class="lableText3">Display Company Name:</span>
                <form:input path="disCompanyName" class="job_seeker_password textBox350"  id="dispCompNameId" readonly="true" 
                ...
                <div class="rowEvenNewSpacing"><span class="lableText3">&nbsp;</span><span class="required marginRight5">
                  <form:checkbox path="bHideCompName" disabled="true"/>
                  </span>
				...
				<form:select path="jobPostingType" class="jb_input3 jb_input_width3" disabled="true">
					<form:option value="0" label="Select" />
              ...
              <div class="row marginTop10">
                ...
                <form:input path="jobNumber" class="job_seeker_password textBox350" readonly="true"/>
				...
				<c:if test = "${not enableJobTitle}">
				 	<form:input path="jobTitle" class="job_seeker_password textBox350" id="jobTitleId" readonly="true" 
                ...
                <h3>Application Method</h3>
                      ...
                      <form:radiobutton path="applMethod" class="marginLeft30" disabled="true" value="ApplyToEMail" id="applyToEMailId" />
                        </span><span class="lableText6">Apply-to Email:</span>
                <form:input path="applyEmail" class="job_seeker_password textBox350"  id="applyToEMailTSId" readonly="true"/>

                <span class="required requiredWidth">Enter the email address where you would like resumes to be sent.</span> </div>
                      <div class="rowEvenNewSpacing"><span class="required lableText6-span">
                        <form:radiobutton path="applMethod" class="marginLeft30" disabled="true" value="ApplyToURL" id="applyToURLId"/>
                        </span><span class="lableText6">Apply-to URL</span>
                <form:input path="applyUrl" class="job_seeker_password textBox350"  id="applyToURLTSId" readonly="true"/>
                <span class="required requiredWidth">Enter the URL where you would like to send job-seekers to apply.</span> </div>

                      <div class="rowEvenNewSpacing"><span class="required lableText6-span">
                        <form:radiobutton path="applMethod" class="marginLeft30" disabled="true" value="ApplyToATS" id="applyToATSId"/>
                        </span><span  class="lableText6">Apply-to ATS</span>
               <form:input path="atsUrl" class="job_seeker_password textBox350" id="applyToATSIPId" readonly="true"/>
                ...
                <form:input path="jobCity" class="job_seeker_password textBox350"  id="cityAutoPopulation" readonly="true"/>
				...
				<form:select path="jobState" class="jb_input3 jb_input_width3" id="stateDpId" disabled="true">
					<form:option value="0" label="Select" />
                ...
                <form:input path="jobZipCode" class="job_seeker_password textBox350"  id="zipCodeITId" readonly="true"/>
                <div class="floatLeft width210"><span class="required marginRight10">
				...
				<form:select path="jobCountry" class="jb_input3 jb_input_width3" id="countryDpId" disabled="true">
					<form:option value="0" label="Select" />
              ...
              <div class="rowEvenNewSpacing"> <span class="lableText3">Employment Type:</span>
				<form:select path="employmentType" class="jb_input3 jb_input_width3" disabled="true">
					<form:option value="0" label="Select" />
              ...
              <div class="rowEvenNewSpacing"> <span class="lableText3">Required Skills:</span>
                ...
                <form:input path="reqSkills" class="job_seeker_password textBox350" id="reqSkillsId" readonly="true" onKeyDown="limitText(this.form.reqSkillsId,this.form.countdownId1,60);"
                ...
                <form:input path="trackPixel" class="job_seeker_password textBox350" readonly="true"/>
              ...
              <div class="rowEvenNewSpacing MarginBottom10"><span class="lableText3 ">Branding Template:</span>
					<form:select path="brandTemplate" class="jb_input3 jb_input_width3" id="templateId" disabled="true">
              ...
              <div class="clearfix"></div>
                ...
                <h3>Auto Renew</h3>
                      ...
                      <span>
                      <div class="required"><form:radiobutton path="autoRenew" value="Yes" disabled="true"/><label class="greyLabel">Yes</label></div>
                      <div class="required"><form:radiobutton path="autoRenew" value="No" disabled="true"/><label class="greyLabel">No</label></div>
                      </span>
                      <span class="required"> 
