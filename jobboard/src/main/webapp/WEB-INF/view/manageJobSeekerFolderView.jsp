...
<script type="text/javascript">
	jQuery(document).ready(function() {
		$(".folderdetailList").click(
				
				function() {
					val = $(this).attr("id");
					$.ajax({url : "${pageContext.request.contextPath}/employer/moveToFolder.html?folderId="
						+ val+"&selectedVal=${manageJobSeekerForm.selectedRow}",
		...
		<div class="refineResults">
										...
										<c:forEach items="${manageJobSeekerForm.admFolderDTOList}" var="folder"
											varStatus="folderStatus">
												<div class="buttonRow" >
													<a href="#" id="${folder.folderId}" title="folderdetailList" class="folderdetailList"> ${folder.folderName} </a>
