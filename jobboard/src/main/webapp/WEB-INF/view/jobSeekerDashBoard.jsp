...
<![endif]-->
    ...
    <body class="job_board">
        ...
        <div class="main_wrapper_inside">
          ...
          <div class="logo"><a href=""><img src="images/tranBg.png" width="397" height="74" alt="ToolTip"></a></div>
				...
				<div class="ad_col_right">
                    <img src="images/ads/300x250ad1.png" />
                    <img src="images/ads/300x250ad2.png" />
                    ...
                    <div class="job_search_main job_search_main_height marginBottom20">
						<form method="">
							<div class="search_form">
							  ...
							  <div class="toolTipBefore"><label for="keywords">Job Title, Keywords, Job ID, Company Name </label></div> <div class="toolTip"><span class="classic"><p>Type in your search criteria here. Include any group of terms related to your desired position. Click on 'Advanced Search' below for more options.</p></span></div><br/>
                ...
                <label for="radius">Radius</label>
								...
								<a href="#" class="btn_sm orange jb_search_submit">Find Jobs</a><a href="">Advanced Search</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="">Post Your Resume</a></a>
							</div><!-- search_form -->
							...
							</div><!-- search_info_box2 -->

							<div class="browse_bar bold">
<span>BROWSE JOBS:</span>&nbsp;&nbsp;<a href="">By Job Title</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="">By Employer</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="">By Location</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="">By Employment Type</a>
							</div><!-- browse_bar -->

						</form>
                    </div><!-- job_search_main -->
					<div class="content_columns">
                    <div class="dashboardHeader"> <img src="images/myadvance.png" width="288" height="23" alt="My advance  dashboard"></div>
                    <div class="dashboardcolumn1">
                      <div class="dashboardPanal">
                      <div class="dashboardPanalIconHolder"> <img src="images/UserProfile.jpg" width="30" height="30" alt="User Profile"></div>
                      ...
                      <div class="dashboardPanal">
                      <div class="dashboardPanalIconHolder"><img src="images/SearchAgents.jpg" width="30" height="30" alt="Search"></div>
                      ...
                      <div class="dashboardPanal">
                      <div class="dashboardPanalIconHolder"><img src="images/Activity.jpg" width="30" height="30" alt="Activity"></div>
                      
                      <div class="dashboardPanalcontent"><h2 class="noTopBorder"> My Activity</h2> 
                       <div class="lableTextDashBoard">
                      <p><a href="">View My Saved Jobs (1)</a> </p>
                      </div>
                      <div class="lableTextDashBoard">
                      <p><a href="">View Jobs I've Applied To (1)</a> </p>
                      </div>
                       <div class="lableTextDashBoard">
                    ...
                    <div class="dashboardPanal">
                      <div class="dashboardPanalIconHolder"><img src="images/Resume.jpg" width="30" height="30" alt="Resume"></div>
                      ...
                      <div class="dashboardPanal">
                      <div class="dashboardPanalIconHolder"><img src="images/Subscriptions.jpg" width="30" height="30" alt="Subscription"></div>
