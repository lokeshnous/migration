    ...
    <div class="main">
        ...
        <div class="headerLoginSection">
					...
					<span class="boldText">Welcome, (Job Seeker Name)!</span><br>
					 <div class="floatRight"> <span class="floatLeft"> <a href="">Log Out</a> | <a href="">My Dashboard</a></span></div></div><!-- loginHeader -->
                    <!-- loginHeader -->
					<!-- loginHeader -->
                    </div>
        <!-- loginHeader --> 
        ...
        <ul class="megamenu">
            ...
            <div class="megamenuContainer">
              ...
              <div class="ad_col_right"> <img src="images/ads/300x250ad1.png" /> <img src="images/ads/300x250ad2.png" />
        <div class="follow_us">
                  <h2>Follow Us</h2>
        ...
        <div class="job_search_main">
            ...
            <div class="search_form">
                ...
                <label for="radius">Radius</label>
                      ...
                      <a href="#" class="btn_sm orange jb_search_submit">Find Jobs</a><a href="">Advanced Search</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="">Post Your Resume</a></div>
            <!-- search_form -->
        ...
        <div class="content_columns">
                  <div class="column1"> <a href="">
                    <h2 class="more_link">Career Tools<span>More</span></h2>
                    </a>
            <ul class="tools">
                      <a href="">
              <li><img src="images/Interview_60x.jpg" width="60" height="60" />
                        <div class="toolsTextHolder"><span class="jb">Career Resource Center</span><br />
                  <strong>Advice, blogs, webinars and more.</strong></div>
                      </li>
              </a> <a href="">
              <li><img src="images/resume2.jpg" />
                <div class="toolsTextHolder"><span class="jb">ADVANCE Resume Builder:</span><br />
                  Create or upload an online resume and apply to jobs in healthcare instantly.</div>
              </li>
              </a> <a href="">
              <li class="last"><img src="images/messenger2.jpg" />
                <div class="toolsTextHolder"><span class="jb">ADVANCE Messenger:</span><br />
                  Save customized job and event searches as well as e-mail notifications.</div>
              </li>
              </a>
                    </ul>
          </div>
                  ...
                  <div class="column2"> <a href="">
                    <h2 class="more_link">Featured Employers<span>More</span></h2>
                    </a>
            <div class="featured_emp_slider">
                      <div id="slider1PrevBtn"></div>
                      <div id="slider1">
                <div class="slider1Frames"> <a href="">
                  <div class="slider1FrameA1"> <img src="images/MercyRNlogo.jpg" /> </div>
                  </a> <a href="">
                  <div class="slider1FrameA2"> <img src="images/TempleLogo.jpg" /> </div>
                  </a> </div>
                <div class="slider1Frames" style="background-color: blue;"> </div>
                <div class="slider1Frames" style="background-color: green;"> </div>
              </div>
            ...
            <ul class="news">
                      <a href="">
              <li>Early Predictors of Obesity and Cardiovascular Risk Among American Indian Children - Maternal and Child Health Journal</li>
              </a> <a href="">
              <li>Early Predictors of Obesity and Cardiovascular Risk Among American Indian Children - Maternal and Child Health Journal</li>
              </a> <a href="">
              <li>Early Predictors of Obesity and Cardiovascular Risk Among American Indian Children - Maternal and Child Health Journal</li>
              ...
              <li class="last">Early Predictors of Obesity and Cardiovascular Risk Among American Indian Children - Maternal and Child Health Journal</li>
              </a>
                    </ul>
          </div>
                  <!-- column2--> 
