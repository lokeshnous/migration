...
<div class="row marginTop20 paddingBottom10">           
            <h3 class="marginLeft10"> Equal Opportunity / Affirmative Action</h3> </div>
		  ...
		  <div class="row"> <span class="lableTextSelect marginTop13 ">Veteran Status:</span>
           ...
           <div class="row marginTop20 paddingBottom10">           
            <h3 class="marginLeft10"> Subscriptions</h3> </div>
          <div class="row paddingBottom10 marginLeft10">
           I would like the following sent to me so I can stay up to date with the latest healthcare news and information:
 </div>
...
<div class="rowEvenNewSpacing marginTop25 paddingBottom10 marginLeft10">
               ...
               <input type="submit" value="Back" class="btn_sm orange"  name="Back"/> 
               <input type="submit" value="Finish" class="btn_sm orange" name="Finish"/>
        ...
        <!-- Step 2 -->
          ...
          <div class="ad_col_right"> <img src="../resources/images/ads/300x250ad1.png" /> <img src="../resources/images/ads/300x250ad2.png" />
