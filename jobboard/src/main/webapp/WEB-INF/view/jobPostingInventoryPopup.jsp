...
<div class="popUpContainerWrapper"><form action="" method="">
      ...
      <div class="rowEvenNewSpacing marginTop0">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid">
          ...
          <tr class="Height30">
            <td align="left">Job Template, Universal Geography <br>                  & Premium Sponsored</td>
            <td align="center"></td>
            <td align="center">3</td>
            <td align="center">1</td>
            <!-- <td align="center">&nbsp;</td> -->
      ...
      <div class="rowEvenNewSpacing marginTop20">
        <div class="row FontSize18 boldText"> Job Posting Slot</div>
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid">
            ...
            <tr class="Height30">
              <td align="left">Job Template, Universal Geography & Premium Sponsored</td>
              <td align="center"></td>
              <td align="center">3</td>
              <td align="center">1</td>
              <!-- <td align="center">In Use</td> -->
 ...
 <div class="row marginTop20 paddingBottom10"><a href="" class="btn_sm orange">BUY MORE</a><a href="" class="btn_sm orange">Cancel</a></div>
          </form></div>
