...
<div class="main_wrapper_outside">
    ...
    <div class="main">
      ...
      <div class="input_grp2 marginLeft10">
                  ...
                  <div class="floatLeft"><select name="radius" id="radius" class="jb_input3" >
...
<a href="">Advanced Search</a> </div>
      ...
      <div class="row">
        <div class="row marginTop5 paddingBottom05"><div class="floatLeft"><h1 class="FontSize24">200 resumes match your results 
</h1></div> </div>
             ...
             <div class="content_columns_search_results">
                        ...
                        <div class="buttonRow">Nurse <div class="floatRight"><a href=""><img src="images/CloseGray.jpg" alt="close" width="15" height="15"> </a></div>
                          </div>
                        <div class="buttonRow">
                          19406
                            <div class="floatRight"><a href=""><img src="images/CloseGray.jpg" alt="close"> </a></div> 
                          </div><div class="buttonRow">
                         25 miles 
                         <div class="floatRight"><a href=""><img src="images/CloseGray.jpg"  alt="close" width="15" height="15"> </a></div></div>
                         <div class="section">
...
<div class="searchResultsNavigationColumn2">
                                        ...
                                        <span><a href="">Next<img src="images/ArrowRight.png"></a></span>
                                  </div>
                              </div>
                              <div class=" floatLeft marginBottom15 marginTop10">
                                     		<a href="" class="btn_sm orange">Move Checked Candidates To Folder </a>
           </div>
                              
 
                            
                            <div class="row marginTop0">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid4">
              <tr class=" borderBottomNone LightGrayBG ">
                <th width="1%" align="left" valign="top" scope="col">&nbsp;</th>
                <th width="22%" align="left" valign="top" scope="col">	
  <input type="checkbox" name="checkbox" id="checkbox" class="marginRight5">
  <label for="checkbox">Desired Position</label>
</th>
                <th width="15%" align="left" valign="top" scope="col">Applicant Name</th>
                <th width="13%" align="left" valign="top" scope="col">Location</th>
                <th width="6%" align="center"  valign="top"scope="col">Exp.</th>
                <th width="15%" align="center"  valign="top"scope="col">Employment Type</th>
              ...
              <tr >
                ...
                <td align="left" valign="bottom"><input type="checkbox" name="checkbox2" id="checkbox2" class="marginRight5">
                  <label for="checkbox2"><a href="#">Per Diem Surgical Care</a></label></td>
...
Amy Mather</td>
                ...
                <td>Yes</td>
                <td>06/27/2012</td>
                <td align="center"><a href="#"><img src="images/View.png" width="20" height="20" alt=""></a>&nbsp;<img src="images/Download.png" width="20" height="20" alt="Download">&nbsp;<a href="#"><img src="images/Print2.png" width="20" height="20" alt="print"></a></td>
              </tr>
              <tr >
                <td align="left" valign="bottom">&nbsp;</td>
                <td align="left" valign="bottom"><input type="checkbox" name="checkbox2" id="checkbox2" class="marginRight5">
                  <label for="checkbox2"><a href="#">	
Nursing Shift Manager</a></label></td>
                <td align="left" valign="bottom"> 	
Ashley Relova</td>
              ...
              <tr >
                <td align="left" valign="bottom">&nbsp;</td>
                <td align="left" valign="bottom"><input type="checkbox" name="checkbox2" id="checkbox2" class="marginRight5">
                  <label for="checkbox2"><a href="javascript:void(0)">Per Diem Nurse</a><a href="#"></a></label></td>
...
Sacramento, CA</td>
              ...
              <tr >
                <td align="left" valign="bottom">&nbsp;</td>
                <td align="left" valign="bottom"><input type="checkbox" name="checkbox2" id="checkbox2" class="marginRight5">
                  <label for="checkbox2"><a href="#"> Nursing Shift Manager</a></label></td>
...
<div class="searchResultsNavigation searchResultsNavigationBottom marginTop0">
...
<div class="footer_wrapper">
    ...
    <ul>
              ...
              <li><img src="images/email.png" class="foot_icon"/><a href="#">Sign Up for Enewsletter</a></li>
