...
<form:form method="post"
		action="../employerreg/saveEmployerProfile.html"
		commandName="empRegisterForm" enctype="multipart/form-data">
<c:if test="${not empRegisterForm.advPassUser and not empRegisterForm.oldUser}">
...
<form:form method="post"
		action="../employerreg/saveEmployerProfile.html"
		commandName="empRegisterForm" enctype="multipart/form-data">
<c:if test="${empRegisterForm.advPassUser}">
		<div class="ad_page_top">
			${adPageTop }
		</div>
		<form:hidden path="socialSignUp"/>
...
<form:form method="post"
		action="../employerreg/saveEmployerProfile.html"
		commandName="empRegisterForm" enctype="multipart/form-data">
<c:if test="${empRegisterForm.oldUser}">
		<div class="ad_page_top">
			${adPageTop }
		</div>
		<form:hidden path="socialSignUp"/>
							...
							<c:forEach items="${empRegisterForm.listProfAttribForms}"
								...
								<c:if test="${profAttrib.strLabelName == 'Company'}">
									<div class="rowEvenNewSpacing">
										...
										<span class="lableText3"></span>
										<div class="floatLeft">
										Health System:&nbsp;&nbsp; </div> <div class="floatLeft"> <form:checkbox path="helthSystem" disabled="${empRegisterForm.bReadOnly}"/>
										</div><div class="toolTip marginLeft5">
											<span class="classic">check this box if your company is a health system and you wish to post jobs at the individual facility level</span>
										</div>
									</div>
								...
								<c:if test="${profAttrib.strLabelName == 'State / Province'}">
									<div class="row">
										...
										<form:select name="stateDpId" id="stateDpId"
											path="listProfAttribForms[${status.index}].strLabelValue"
											class="jb_input3 jb_input_width3" disabled="${empRegisterForm.bReadOnly}">
											<form:option value="0" label="Select" />
											<form:options items="${profAttrib.dropdown}"
												itemValue="optionId" itemLabel="optionName" />
										</form:select>
								...
								<c:if test="${profAttrib.strLabelName == 'Zip Code'}">
									<div class="rowEvenNewSpacing">
										...
										<form:input
											path="listProfAttribForms[${status.index}].strLabelValue"
											type="text" name="zipCode" id="zipCode"
											class="job_seeker_password textBox350" maxlength="5" readonly="${empRegisterForm.bReadOnly}"/>
										<span class="required">(Required)</span>
									</div>
								</c:if>
								<c:if test="${profAttrib.strLabelName == 'Country'}">
									<div class="row">
										...
										<form:select
											path="listProfAttribForms[${status.index}].strLabelValue"
											name="countryDpId" id="countryDpId" class="jb_input3 jb_input_width3" disabled="${empRegisterForm.bReadOnly}">
											<form:option value="0" label="Select" />
											<form:options items="${profAttrib.dropdown}"
												itemValue="optionId" itemLabel="optionName" />
										</form:select>
