			...
			<div class="main">
				...
				<div class="header_wrapper">
					...
					<div class="headerLoginSection">
						<div class="headerLoginSectionColumns width205">
							...
							<div class="floatleft">
								<span> <a
									href="/jobboard/loginFormForJobSeeker/login.html">Login</a> | <a
				...
				<div class="ad_col_right">
					<img src="../resources/images/ads/300x250ad1.png"
						class="paddingBottom0" /> <br class="clearfix" />
				...
				<div class="content_wrapper">
							...
							<div class="loginOptions">
								...
								<div class="rowEvenSpacing">
									<span class="floatLeft"><input type="submit"
										class="btn_sm orange" value="Login" /></span> <span
										class="floatLeft"><a href="forgrtPasswordLogin.html"
										id="forgrtpassword">Forgot your password?</a></span>
								</div>
								<div class="rowEvenSpacing">
									<p>
										<span class="bold">Not a member?</span> <a
											href="/jobboard/jobseekerregistration/createJobSeekerCreateYrAcct.html">Sign
											up now!</a>
									</p>
								</div>
					...
					<div class="job_seeker_social_login">
						<p class="bold lableLetterSpacer">Login with your social
							networking account</p>
						<a href=""><img src="../resources/images/loginFB.png"
							alt="Login with Facebook" /></a> <a href=""><img
							src="../resources/images/loginIN.png" alt="Login with LinkedIn" /></a>
					</div>
