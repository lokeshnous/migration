			...
			<div class="main">
							...
							<div class="headerLoginSectionColumns width205">
								...
								<div class="PopUpToolTip">
									<a href="#">Why <strong>advance</strong>?
										...
										<div class="FontWeight FontSize12 OrangeDot FontBlack">
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The latest news,
											articles, product reviews and much more!</div>
				...
				<div class="row">
						...
						<form method="">
							<div class="search_form">
								...
								<a href="#" class="btn_sm orange jb_search_submit">Find Jobs</a><a
									href="">Advanced Search</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="">Post
									Your Resume</a>
							</div>
							<!-- search_form -->
							...
							<div class="browse_bar bold">
								<span>BROWSE JOBS:</span>&nbsp;&nbsp;<a href="">By Job Title</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
									href="">By Employer</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="">By
									Location</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="">By Employment
									Type</a>
							</div>
					...
					<div class="ad_col_right">
						<img src="../resources/images/ads/300x250ad1.png" class="paddingBottom0" /> <br
							class="clearfix" />
					</div>
				</div>
				<!-- ad_col_right -->
				...
				<div class="row">
					...
					<ul class="employersList">
						...
						<li><a href="featuredemployerdetails.html?id=${companyProfileDTO.facilityid }"><img src="${companyProfileDTO.logoPath}" alt="${companyProfileDTO.companyName }"></a></li>
						</c:forEach>
					</ul>
