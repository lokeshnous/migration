    ...
    <div class="main">
        ...
        <div class="header_wrapper"> <a href="">
          <div class="logo"></div>
            ...
            <div class="headerLoginSectionColumns width205"> <span class="boldText">Job Seeker:</span><br>
                      <div class="PopUpToolTip"><a href="#">Why <strong>advance</strong>?</a> <span class="classic01">
                        <p class="FontWeight marginBottom10">When you sign up, ADVANCE gives you:</p>
                        <div class="FontWeight FontSize12 OrangeDot FontBlack"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Access to thousands of healthcare job opportunities </div>
                        <div class="FontWeight FontSize12 OrangeDot FontBlack"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The best healthcare content you can get anywhere </div>
                        <div class="FontWeight FontSize12 OrangeDot FontBlack"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hours of informative and entertaining multimedia </div>
                        <div class="FontWeight FontSize12 OrangeDot FontBlack"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The latest news, articles, product reviews and much more! </div>
                        <p class=" marginTop10">And it's all FREE!</p>
                        </span> </div>
                      <div class="floatleft"><span> <a href="">Login</a> | <a href="">Sign Up</a> | </span></div>
                    </div>
            <!-- loginHeader -->
            ...
            <!-- loginHeader --> 
              ...
              <div class="row">
        <div id="nav" class="marginBottom0">
                  <ul class="megamenu">
        ...
        <div class="row marginTop5">
            ...
            <h2 class="width305 FloatLeft TextColor04">JOB DETAILS </h2>
            <h2 class="width150 floatRight UpperCaseNone"><a href="#" class="TextColorA05">Return to Search Results</a></h2>
          </div>
                  <!--LOGO AREA-->
                  <div class="row marginTop16">
            <div class="LogoAreaBox"><img src="images/emplogo.png" alt="logo" width="335" height="60" border="0"></div>
          </div>
                  <!--BANNER AREA-->
                  <div class="row">
            <div class="BannerAreaBox ColorTheme">
                      <div class="BannerAreaInnerBox">
                <div class="BannerImgBox"> <img src="images/img04.png" width="490" height="319" alt="img"></div>
            ...
            <div class="ContantMiddleBox">
                ...
                <div class="ContantMiddleLeftLink">
                    ...
                    <div class="ShareArea marginLeft5"> <span>
                      <p class="FloatLeft marginTop3">Send to friend:</p>
                      <a href="#" >&nbsp;<img src="images/email.png"></a></span> </div>
                    <div class="ShareArea BorderLeft"> <span>
                      <p class="FloatLeft marginTop3">Share:</p>
                      <span>&nbsp;<a href=""><img src="images/fbook_sm.png"></a></span> <span><a href=""><img src="images/L_In_sm.png"></a></span> <span><a href=""><img src="images/twitter_sm.png"></a></span></span> </div>
                    <div class="ShareArea BorderLeft paddingRight0"> <span>
                      <p class="FloatLeft marginTop3">Print:</p>
                      <span>&nbsp;<a href=""><img src="images/Print.png"></a></span></span> </div>
                  </div>
                          <div class="clearfix"></div>
                          <div class="DotBorderBottom marginTop20 width295 marginLeft10"></div>
                        </div>
                <div class="row marginTop20 marginLeft10 width310">
                    ...
                    <p>00000000</p>
                          ...
                          <div class="clearfix"></div>
                          <div class="DotBorderBottom marginTop20 width295"></div>
                        </div>
                <!---->
                <div class="row">
                          <div class="ContantLeftBlueBox ColorTheme">
