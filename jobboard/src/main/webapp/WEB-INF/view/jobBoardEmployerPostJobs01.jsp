				...
				<div class="main">
					...
					<div class="row">
						...
						<div class="MidContent_Wrapper FloatLeft marginTop15">
							...
							<div class="MidContentBox01 marginLeft20">
								...
								<p class="marginTop10 lineHeight16">Do you have staffing
									needs that change rapidly? Purchase 'slots' that can be used
									and reused as many times as you need for 30 days.</p>
								<div class=" paddingBottom05 marginTop5"></div>
								<div class="cont_info_box2 AutoWidth marginTop5">
									<ul>
							...
							<div class="MidContentBox01 marginLeft20">
								...
								<p class="marginTop10 lineHeight16">
									...
									This valuable service automatically adds all of your listings
									to the <em>ADVANCE</em> Healthcare Jobs website. Choose from a
						...
						<div class="MidContent_Wrapper FloatLeft marginTop15">
							...
							<div
								...
								<div class="BoxContantIn lineHeight16">
									...
									<br />
									<p>
										<strong>PR Upgrade:</strong> We include a feed on your full
										job posting pages to highlight the latest news, articles and
						...
						<div
							...
							<h1
								class=" TextColorA01 FontSize19 marginTop4 width255 FloatLeft">
